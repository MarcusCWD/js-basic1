...
// because we did not define speed as variable in the function, 
// it will return error...
// that is why we use they key word 'this' to
// refer to the object within the property 'starDestroyer'
let starDestroyer = {
    speed: 25,
    calculateDistanceTravelled: function(time) {
